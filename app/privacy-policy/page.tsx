...
const PrivacyPolicy = () => {
  return (
    <div className="max-w-3xl mx-auto md:py-10 h-screen">
      <div className="h-full p-5 border rounded-xl flex flex-col relative shadow-2xl overflow-y-scroll shadow-primary-foreground">
        <p>
          Go back to{" "}
          <Link
            href="/"
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Chatroom.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Chatroom, accessible from{" "}
              <a
                href="newchatroom.vercel.app"
                rel="external nofollow noopener"
                target="_blank"
              >
                newchatroom.vercel.app
              </a>
            </p>
          </li>
          <li>
